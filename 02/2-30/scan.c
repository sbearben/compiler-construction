...
/* Exercise 2-30 - Flag to indicate whether the chracter should be consumed */
int shouldConsume = TRUE;
// Exercise 2-30 Potentially need the previous character across calls to getToken, so make global
static int c;
